...
public class UserEntity {
    ...
    public UserEntity(Integer id, String uuid, RoleEntity role, String email, String password, String firstName, String lastName, String mobilePhone, int status, int failedLoginCount, ZonedDateTime lastPasswordChangeAt, ZonedDateTime lastLoginAt, String salt, Long version, String createdBy, ZonedDateTime createdAt, String modifiedBy, ZonedDateTime modifiedAt) {
        this.id = id;
        this.uuid = uuid;
        this.role = role;
        this.email = email;
